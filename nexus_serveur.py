...
def nxc_bank_print():
    """Retourne une page HTML imprimable avec toutes les informations de la banque NXC."""
    body = request.get_json(force=True, silent=True) or {}
    ...
    try:
        ...
        html = (
            ...
            ".stitle { font-size:12px; text-transform:uppercase; letter-spacing:1px; color:#888;"
